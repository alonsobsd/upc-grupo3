...
knitr::kable(cwe.legend1, caption = "Tabla de CWE que son parte del CWE Top List")
```
\
\
...
knitr::kable(cwe.legend2, caption = "Tabla de CWE que son parte del OWASP Top List")
```
\
\
